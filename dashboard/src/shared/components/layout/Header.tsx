...
import { RefreshCw, AlertCircle, Square, CheckCircle2 } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-[#303030] mx-1 select-none">·</span>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            {isAnalyzing ? (
              ...
              >
                <RefreshCw size={11} />
                <span className="hidden sm:block">Re-analizar Todo</span>
              </button>
            )}
          </div>
        </div>
        ...
        {/* Analyzing sub-row */}
        {isAnalyzing && (
          <div className="absolute bottom-[10px] left-5 right-5 flex items-center gap-2 pointer-events-none">
            <span className="text-[10px] text-[#505050] truncate">
